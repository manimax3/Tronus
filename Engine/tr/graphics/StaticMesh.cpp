                                      ...
                                      ResourceLoadingContext     context)
{
    ...
    try {
        ...
        return ResourcePtr<>(new PhongMaterial(
            ResCast<Texture>(std::get<1>(at)->lock()),
